...
def ls_dir(data):
    import os
    return data['path']
    # return os.path.listdir('.')
    # return os.listdir(os.path.dirname(data['path']))
...
class XPCSManifestTool(GladierDefaults):
    ...
    flow_input = {
        ...
        'manifest_destination': 'globus://08925f04-569f-11e7-bef8-22000b9a448b/projects/APSDataAnalysis/Automate/',
        # Contains tutorial files on /share/godata/ for Globus Tutorial Endpoint 1
