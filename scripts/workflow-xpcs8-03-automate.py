  ...
  'stages': {
    '01-Staging' : {
      'command': '/home/beams/8IDIUSER/DM_Workflows/xpcs8/start-xpcs8-remote-automate-01.sh \
        ...
        $fileDataDir \
        $xpcsGroupName \
        $sgeQueueName', ## Fix start command here?
    ...
    '04-MonitorAutomate' : {
      'command': '/bin/echo Automate ID: $AutomateId'},
    '05-Automate_Transfer1': {
      'command': 'ssh 8idiuser@talc "/home/beams/8IDIUSER/DM_Workflows/xpcs8/automate/automate_wait.py --task_id $AutomateId --step Transfer1 --walltime 120"'
      },
    '06-Automate_XPCS': {
      'command': 'ssh 8idiuser@talc "/home/beams/8IDIUSER/DM_Workflows/xpcs8/automate/automate_wait.py --task_id $AutomateId --step ExecCorr --walltime 900"'
      },
    '07-Automate_CopyBack': {
      'command': 'ssh 8idiuser@talc "/home/beams/8IDIUSER/DM_Workflows/xpcs8/automate/automate_wait.py --task_id $AutomateId --step Transfer2 --walltime 60"'
      },
  },
