##dm-upsert-workflow --py-spec workflow-xpcs8-01-gladier.py
{
    ...
    'stages': {
            ...
            '05-Automate_AcquireNodes': {'command': 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/raf/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step AcquireNodes --timeout 86400"'},
            '06-Automate_Corr': {'command': 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/raf/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step EigenCorr --timeout 7200"'},
            '07-Automate_Plots': {'command': 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/raf/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step MakeCorrPlots --timeout 7200"'},
            '08-Automate_TransferBack': {'command': 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/raf/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step GatherXpcsMetadata --timeout 120"'},
	    }
}
