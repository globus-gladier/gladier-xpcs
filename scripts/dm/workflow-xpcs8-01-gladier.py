    ...
    "stages": {
        "01-Staging": {
            ...
            "outputVariableRegexList": [
                ...
                "HADOOP FUSE DIR: (?P<HADOOP_FUSE_DIR>.*)",
                "ID8I DATA ROOT: (?P<ID8I_DATA_ROOT>.*)",
                ...
                "XPCS JOB FOLDER: (?P<XPCS_JOB_FOLDER>.*)",
                "SOURCE ENDPOINT UUID: (?P<SOURCE_ENDPOINT_UUID>.*)",
        ...
        "04-Automate_TransferOut": {
            "command": 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step TransferFromClutchToTheta"'
        },
        "05-Automate_AcquireNodes": {
            "command": 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step AcquireNodes"'
        },
        "06-Automate_Corr": {
            "command": 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step EigenCorr"'
        },
        "07-Automate_Plots": {
            "command": 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step MakeCorrPlots"'
        },
        "08-Automate_TransferBack": {
            "command": 'ssh 8idiuser@talc "/home/beams10/8IDIUSER/DM_Workflows/xpcs8/automate/gladier-xpcs/scripts/get_status.py --run_id $AutomateId --step GatherXpcsMetadata"'
        },
    },
}
