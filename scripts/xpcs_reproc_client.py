...
def register_container():
    ...
    eigen_cont_id = fxc.register_container(
        location=cont_dir + container_name, container_type="singularity"
    )
...
if __name__ == "__main__":
    ...
    flow_input = re_cli.get_xpcs_input(
        depl, args.hdf, args.imm, args.qmap_source_globus_path
    )
    ...
    corr_flow = re_cli.run_flow(
        flow_input=flow_input, label=re_cli.get_label(flow_input)
    )
